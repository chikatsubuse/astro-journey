document.addEventListener('DOMContentLoaded', () => {
    ...
    const historicalFigures = {
        'prologue': [
            { name: '古代の天物を学者たち（バビロニア、エジプト、ギリシャ）', desc: 'まだ神話と科学が分かたれていない時代、夜空の星々の動きに規則性を見出し、記録しようと試みた無数の人々がいました。彼らの飽くなき探求心が、天文学という壮大な学問の第一歩を記しました。' }
        ],
        'stage1': [
            { name: '吟遊詩人・語り部（ホメロス、グリオなど）', desc: '文字が普及する前、壮大な物語や歴史は、卓越した記憶力を持つ「語り部」たちの口を通して世代から世代へと伝えられました。彼らは、情報をエンターテイメントとして魅力的にパッケージ化する、最初期の情報スペシャリストでした。' }
        ],
        'stage1-5': [
            { name: '名もなき古代の絵師たち', desc: '特定の個人はいませんが、フランスのラスコーやスペインのアルタミラの洞窟に、星や動物を描いた絵師たちがいました。彼らは、文字のない時代に、天体の動きといった重要な情報を「絵」という形で記録し、未来へ伝えようとした最初期の情報伝達者と言えるでしょう。' },
            { name: 'シュメール人', desc: '世界で初めて本格的な文字システム「楔形文字」を発明したとされる人々。彼らは粘土板に葦のペンで文字を刻むことで、口承よりもはるかに正確で永続的な情報記録を実現しました。天体の観測記録や法律、物語など、彼らの記録が文明の礎を築きました。' }
        ],
        'stage2': [
            { name: 'シュメールの書記', desc: '世界で初めて本格的な文字「楔形文字」を発明したシュメール人。その中でも専門職である「書記」は、粘土板に葦のペンで文字を刻むことで、口承よりはるかに正確で永続的な情報記録を実現し、文明の礎を築きました。' }
        ],
        'stage2-5': [
            { name: 'ジャン＝フランソワ・シャンポリオン', desc: 'フランスの言語学者。古代エジプトの神聖文字「ヒエログリフ」を解読した人物です。彼のおかげで、忘れ去られていた古代の記録が現代に蘇りました。情報は「記録する」ことと同じくらい、「読み解く」ことが重要なのです。' },
            { name: 'イムホテプ', desc: '古代エジプトの宰相であり、医師、建築家としても知られる伝説的人物。彼はパピルスに医学書を記したとされ、知識を体系的に記録し、後世に伝えることの重要性を体現しています。彼の名は、書記文化の象徴とも言えるでしょう。' }
        ],
        'stage3': [
            { name: '中世ヨーロッパの修道士', desc: '西洋古典文明の知識が失われかけた暗黒時代、修道院の写本室で聖書や古代の文献をひたすら書き写し続けた修道士たち。彼らの地道な労働がなければ、多くの貴重な情報が歴史の闇に消えていたことでしょう。' }
        ],
        'stage3-5': [
            { name: 'カリマコス', desc: '古代アレクサンドリア図書館の学者。彼は図書館の膨大な蔵書を整理するため、『ピナケス』と呼ばれる世界初の図書目録を作成しました。これは、単に本を並べるだけでなく、情報を分類し、検索可能にする「メタデータ」の考え方の原点です。' },
            { name: 'エラトステネス', desc: 'アレクサンドリア図書館の館長を務めたギリシャの学者。彼は図書館の知識を活用し、地球の大きさを驚くほど正確に計算しました。知識を集積するだけでなく、それを応用して新たな発見を生み出す、学問の理想像を示しています。' }
        ],
        'stageX': [
            { name: '錬金術師たち', desc: '科学的な探求が異端とされた時代、錬金術師たちは独自の記号や寓意に満ちた文章で、自らの発見を暗号化して記録しました。彼らの活動は、情報統制下で知識を伝承しようとする人間の知恵の現れでした。' }
        ],
        'stage4': [
            { name: 'ヨハネス・グーテンベルク', desc: '活版印刷技術の発明者。彼の発明により、本を安価かつ大量に複製できるようになり、知識が聖職者や王侯貴族から一般市民へと広がる「知識の民主化」が起こりました。科学の発展も、この革命なくしてはあり得ませんでした。' },
            { name: 'アルドゥス・マヌティウス', desc: 'ヴェネチアの出版人。彼は、持ち運びやすい小型の本（文庫本の原型）を出版したり、読みやすい書体（イタリック体）を開発したりするなど、印刷物をより多くの人々にとって身近なものにしました。技術を普及させる「編集」や「デザイン」の重要性を示した人物です。' }
        ],
        'stage4-5': [
            { name: 'ドゥニ・ディドロ & ジャン・ル・ロン・ダランベール', desc: 'フランスの哲学者・数学者で、『百科全書』の共同編纂者。彼らは世界中の知識を体系的に整理し、相互に関連付けることで、知識を一つの巨大なネットワークとして示しました。これは、インターネットにおけるハイパーリンクの思想的な源流とも言えます。' },
            { name: 'カール・フォン・リンネ', desc: '「分類学の父」と称されるスウェーデンの博物学者。彼は動植物を「二名法」という一貫したルールで分類・命名し、膨大な自然界の情報を整理しました。百科全書派が人文知を体系化したとすれば、リンネは自然科学の知識を体系化した偉人です。' }
        ],
        'stage4-8': [
            { name: 'ルイ・ジャック・マンデ・ダゲール', desc: '写真技術「ダゲレオタイプ」を発明した芸術家・化学者。彼のおかげで、人類は初めて人間の主観を介さず、「光そのもの」を客観的な映像として記録できるようになりました。天文学においても、写真は人間の目を超える精密な観測記録を可能にしたのです。' },
            { name: 'ウィリアム・ヘンリー・フォックス・タルボット', desc: 'ネガポジ法を発明したイギリスの科学者。ダゲールの一枚きりの写真と異なり、彼の発明した「カロタイプ」は一枚のネガから何枚も同じ写真を複製できました。これにより、写真は「複製可能な視覚情報」となり、より広く普及する道が開かれました。' }
        ],
        'stage5': [
            { name: 'サミュエル・モールス & アルフレッド・ヴェイル', desc: '電信とモールス符号を発明したことで知られる二人。モールスが全体構想を、ヴェイルがより実用的な装置の開発や符号の改良で貢献しました。これにより情報は物理的な移動から解放され、光速で遠隔地へ伝わるようになりました。' },
            { name: 'ジェームズ・クラーク・マクスウェル', desc: '電磁波の存在を理論的に予言した物理学者。彼の「マクスウェル方程式」がなければ、後の無線通信（ラジオ、テレビ、携帯電話）は生まれませんでした。目に見えない情報の通り道「電波」の存在を数式で示した、真のパイオニアです。' }
        ],
        'stage5-5': [
            { name: 'グリエルモ・マルコーニ', desc: '無線電信を実用化し、大西洋を横断する通信に成功した技術者。彼の業績は、特定の相手にしか送れなかった情報を、不特定多数に同時に届ける「放送（ブロードキャスティング）」という概念を生み出しました。' }
        ],
        'stageY': [
            { name: 'アラン・チューリング', desc: 'イギリスの天才数学者。第二次世界大戦中、ドイツ軍の暗号「エニグマ」を解読する機械を開発し、連合国を勝利に導きました。彼の業績は現代コンピュータの基礎理論にも繋がっており、「コンピュータ科学の父」と呼ばれています。' },
            { name: 'クロード・シャノン', desc: '「情報理論の父」と呼ばれるアメリカの数学者・工学者。彼は、情報を数学的に定義し、通信におけるノイズや誤りをどう克服するかという理論を確立しました。暗号技術だけでなく、現代のあらゆるデジタル通信の根幹を支える理論を築きました。' }
        ],
        'stage6': [
            { name: 'ケン・トンプソン & デニス・リッチー', desc: 'オペレーティングシステム「UNIX」とプログラミング言語「C言語」を開発した伝説的な技術者。彼らが築いたコマンドラインによる対話文化や設計思想は、現代の多くのサーバーやスマートフォンにも受け継がれています。' },
            { name: 'グレース・ホッパー', desc: '初期のコンピュータプログラマであり、海軍軍人。彼女は、人間が理解しやすい言語でプログラムを書き、それを機械語に「コンパイルする」というアイデアを提唱・開発しました。専門家しか使えなかったコンピュータを、より多くの人が使えるようにした功労者です。' }
        ],
        'stage6-5': [
            { name: 'ティム・バーナーズ＝リー', desc: 'World Wide Web（WWW）の基本技術（URL, HTTP, HTML）を発明した科学者。彼は、世界中のコンピュータに散らばる情報を、誰もが自由に閲覧し、ハイパーリンクで繋ぐことができる仕組みを考案し、現代のインターネットの礎を築きました。' }
        ],
        'stage7': [
            { name: 'ダグラス・エンゲルバート', desc: 'マウス、ウインドウ、ハイパーテキストなど、現代のPCの当たり前を発明した「未来の預言者」。彼はコンピュータを、専門家だけの計算機から、誰もが直感的に操作できる「知の道具」へと変える未来を思い描きました。' },
            { name: 'アラン・ケイ', desc: 'エンゲルバートの思想を発展させ、「誰もが持てるノートブックサイズのコンピュータ（ダイナブック構想）」を提唱した研究者。彼は、重なり合うウィンドウやアイコンといったGUIを開発し、特に子供たちの教育にコンピュータを活用することを目指しました。' }
        ],
        'stage7-5': [
            { name: 'ティム・バーナーズ＝リー', desc: 'World Wide Web（WWW）の発明者。彼は、文書同士をリンクで繋ぐ「ハイパーテキスト」システムを考案し、URL、HTTP、HTMLといったWebの基本技術を開発しました。彼のおかげで、世界中の情報が繋がり、誰もがアクセスできる巨大な知識の網が生まれました。' },
            { name: 'ラリー・ペイジ & セルゲイ・ブリン', desc: 'Googleの創業者。彼らは、「多くの質の高いページからリンクされているページは、より重要である」という画期的なアルゴリズム（PageRank）を発明し、爆発的に増え続けるWeb情報の中から、必要な知識を効率的に見つけ出すことを可能にしました。' }
        ],
        'stage8': [
            { name: 'アッシュ・ヴァスワニと "Attention Is All You Need" の著者たち', desc: '現代の対話型AIの能力を飛躍的に向上させた、革命的な機械学習モデル「Transformer」を2017年に発表したGoogleの研究者チームです。彼らの発明により、AIは文章の文脈を深く理解できるようになり、人間と自然に対話する時代の扉が開かれました。' },
            { name: 'ジェフリー・ヒントン', desc: '「AIのゴッドファーザー」の一人。彼は、人間の脳神経を模した「ニューラルネットワーク」の研究を長年続け、現代のAIブームの礎となる「ディープラーニング（深層学習）」の技術を発展させました。AIが自らデータから学習する能力は、彼の研究なくしてはあり得ませんでした。' }
        ],
        'stage9': [
            { name: 'イーライ・パリサー', desc: 'インターネット活動家。SNSなどのアルゴリズムが、ユーザーが見たい情報ばかりを表示することで、無意識のうちに視野が狭まる「フィルターバブル」という現象を指摘しました。情報へのアクセスが容易になった現代だからこそ、真偽を見抜く力が求められます。' },
            { name: 'ショシャナ・ズボフ', desc: '社会心理学者。彼女は、IT企業が人々の行動データを収集・分析し、利益を得る現代の資本主義を「監視資本主義」と名付け、警鐘を鳴らしました。利便性の裏にある、プライバシーや自由な意思決定へのリスクについて考えるきっかけを与えてくれます。' }
        ],
        'stage10': [
            { name: 'ミゲル・ニコレリス', desc: '脳と機械を繋ぐ「ブレイン・マシン・インターフェース（BMI）」研究の世界的権威。彼は、思考するだけでロボットアームを動かす実験を成功させました。彼の研究は、いつか人類が思考の速さでコンピュータと対話する未来を示唆しています。' },
            { name: 'レイ・カーツワイル', desc: '人工知知能研究の権威であり、未来予測で知られる発明家。彼は、技術の進歩が加速し続け、2045年頃にはAIが全人類の知能を超える「技術的特異点（シンギュラリティ）」に到達すると予測しています。思考とAIが融合する未来を考える上で、彼のビジョンは欠かせません。' }
        ],
        'extra1': [
            { name: 'サトシ・ナカモト', desc: 'ビットコインと、その中核技術である「ブロックチェーン」を世界で初めて実装した、正体不明の個人またはグループ。特定の管理者なしに参加者全員で情報の正しさを維持するこの技術は、記録の「信頼」のあり方を根本から変える可能性を秘めています。' },
            { name: 'ヴィタリック・ブテリン', desc: 'ブロックチェーン技術を、仮想通貨だけでなく、契約やアプリケーションなど、より幅広い用途に応用するプラットフォーム「イーサリウム」を考案した人物。彼のアイデアにより、ブロックチェーンは単なる記録技術から、分散型の社会インフラへと進化する可能性が示されました。' }
        ],
        'extra2': [
            { name: 'リチャード・ファインマン', desc: 'ノーベル賞を受賞した物理学者。彼は、複雑な自然現象をシミュレーションするためには、その現象と同じ原理で動く「量子コンピュータ」が必要だと提唱しました。彼のアイデアが、現在の量子コンピュータ研究の出発点となりました。' },
            { name: 'ピーター・ショア', desc: '量子コンピュータが実用化された場合、現在の暗号技術の多くを簡単に解読できてしまう「ショアのアルゴリズム」を発見した数学者。彼の発見は、量子コンピュータの驚異的な計算能力を示すと同時に、未来の情報セキュリティに新たな課題を投げかけました。' }
        ],
        'extra5': [
            // エクストラ5は特定の人物より概念が重要なので、少し違った切り口で
            { name: '未来のデジタル考古学者', desc: '21世紀のデータは、20世紀の紙媒体よりも遥かに失われやすいと言われています。フォーマットの陳腐化、媒体の劣化、サービスの終了…。未来の歴史家は、私たちが残した膨大なデジタル記録の中から、意味のある情報を発掘する「デジタル考古学者」になるのかもしれません。' }
        ]
    };
    // --- Game State ---
    ...
    nextBtn.addEventListener('click', () => {
        ...
        // ★追加: 次のステージに進む前に、現在のステージの偉人情報をチェック
        if (historicalFigures[currentStageId] && nextStageIndex < stages.length) {
            showFigureModal(currentStageId);
        } else if (nextStageIndex < stages.length) {
            showStage(nextStageIndex);
        }
    });
    ...
    // ★追加: 新しい関数
    function showFigureModal(stageId) {
        const figures = historicalFigures[stageId];
        if (!figures) { // もし該当する人物データがなければ
            nextBtn.disabled = false; // 通常通りボタンを有効化
            return;
        }

        const modal = document.getElementById('figure-modal');
        const detailsDiv = document.getElementById('figure-details');
        detailsDiv.innerHTML = ''; // 中身をクリア
    ...
    // ★追加: モーダルを閉じる処理
    document.getElementById('figure-modal-close').addEventListener('click', () => {
        document.getElementById('figure-modal').style.display = 'none';
        // ★修正点: モーダルを閉じたら、次のステージを表示する
        const nextStageIndex = currentStageIndex + 1;
